...
public class MenuDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
        db.execSQL("INSERT INTO TEST VALUES(NULL, 0, '매운떡볶이', '3500원', '고추장, 쌀떡, 오뎅');");
        db.execSQL("INSERT INTO TEST VALUES(NULL, 0, '로제떡볶이', '4000원', '우유, 치즈, 누들떡, 차돌');");
        db.execSQL("INSERT INTO TEST VALUES(NULL, 0, '짜장떡볶이', '3000원', '춘장, 밀떡, 계란');");
    }
    @Override
